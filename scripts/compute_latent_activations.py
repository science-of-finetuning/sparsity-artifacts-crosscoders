    ...
    if not args.load_from_disk:
        ...
        if len(args.target_set) == 0:
            ...
            for target_set in args.target_set:
                indices.append(th.load(indices_root / f"{target_set}.pt", weights_only=True))
        ...
        out_acts_lmsys, out_ids_lmsys, seq_ranges_lmsys, max_activations_lmsys = get_positive_activations(
