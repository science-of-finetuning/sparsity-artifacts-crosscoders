...
# %%
model1 = load_dictionary_model("gemma-2-2b-L13-k100-lr1e-04-local-shuffling-CCLoss").to("cuda")
model2 = load_dictionary_model("gemma-2-2b-L13-k100-lr1e-04-local-shuffling-SAELoss").to("cuda")



base_cosim = cosine_similarity(model1.decoder.weight[0], model2.decoder.weight[0], dim=1)
chat_cosim = cosine_similarity(model1.decoder.weight[1], model2.decoder.weight[1], dim=1)
...
# %%
max_cosim_base = chunked_max_cosim(model1.decoder.weight[0], model2.decoder.weight[0], chunk_size=8)
max_cosim_chat = chunked_max_cosim(model1.decoder.weight[1], model2.decoder.weight[1], chunk_size=8)
